...
class Sweep():
  ...
  def get_events(self, sweep_dict, base_process, idx_start, num_events):
    '''
    Args: 
    sweep_dict (dic) = dictionary of sweeps;
    base_process (int) = index of base_process;
    idx_start (int) = index of start (time) in the base_process;
    num_events (int) = number of events to get.
    '''
